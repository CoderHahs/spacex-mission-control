...
type NavigationSection = 'globe' | 'launches' | 'satellites' | 'missions' | 'analytics' | 'news';
...
const navItems: { id: NavigationSection; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'satellites', label: 'Satellites', icon: <Satellite className="h-5 w-5" /> },
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg font-bold glow-text">Space Mission Control</h1>
              <p className="text-xs text-muted-foreground">Real-time Space Tracking</p>
            </div>
          </div>
