...
export async function getPastLaunches(limit = 10): Promise<Launch[]> {
  const data = await fetchAPI<PaginatedResponse<Launch>>(
  ...
  return [
    {
      ...
      status: { id: 1, name: 'Go for Launch', abbrev: 'Go', description: 'Current T-0 confirmed' },
      net: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
      window_start: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
      window_end: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 1,
        name: 'Starlink Group 6-45',
        description: 'A batch of 23 satellites for Starlink mega-constellation.',
        type: 'Communications',
      ...
      rocket: {
        ...
        configuration: {
          ...
          family: 'Falcon',
          variant: 'Block 5',
          image_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/falcon_9_block__image_20210506060831.jpg',
        },
      },
    ...
    },
    {
      ...
      window_end: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 2,
        name: 'Synspective StriX',
        description: 'Synthetic aperture radar satellite for Synspective.',
        type: 'Earth Science',
      ...
      pad: {
        ...
        location: { id: 5, name: 'Rocket Lab LC-1', country_code: 'NZL' },
        latitude: '-39.262833',
      ...
      rocket: {
        ...
        configuration: {
          ...
          full_name: 'Electron',
          family: 'Electron',
          image_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/electron_image_20190705175640.jpg',
        },
      },
      launch_service_provider: {
        id: 147,
        ...
        type: 'Commercial',
        country_code: 'USA',
        logo_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/rocket_lab_logo_20220218075411.png',
      },
    ...
    },
    {
      ...
      status: { id: 2, name: 'TBD', abbrev: 'TBD', description: 'Launch date pending' },
      net: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(),
      window_start: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(),
      window_end: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 3,
        name: 'Progress MS-26',
        description: 'ISS resupply mission carrying food, fuel, and supplies.',
        type: 'Resupply',
        orbit: { id: 8, name: 'Low Earth Orbit', abbrev: 'LEO' },
      },
      pad: {
        id: 32,
        name: 'Site 31/6',
        location: { id: 15, name: 'Baikonur Cosmodrome', country_code: 'KAZ' },
        latitude: '45.996034',
        longitude: '63.564003',
      ...
      rocket: {
        ...
        configuration: {
          ...
          family: 'Soyuz',
          image_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/soyuz_2.1a_image_20190520082937.jpg',
        },
      },
      launch_service_provider: {
        id: 63,
        ...
        type: 'Government',
        country_code: 'RUS',
        logo_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/russian2520federa_image_20190207032459.png',
      },
    ...
    },
    {
      ...
      window_start: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString(),
      window_end: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 4,
      ...
      pad: {
        id: 144,
        name: 'Wenchang LC-1',
        location: { id: 29, name: 'Wenchang Space Launch Site', country_code: 'CHN' },
        latitude: '19.614492',
      ...
      rocket: {
        ...
        configuration: {
          ...
          family: 'Long March 5',
          image_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/long_march_5_ima_image_20190222031219.jpg',
        },
      },
      launch_service_provider: {
        id: 88,
        ...
        type: 'Government',
        country_code: 'CHN',
        logo_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/china_aerospace_s_image_20191118082522.png',
      },
    ...
    },
    {
      ...
      window_start: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000).toISOString(),
      window_end: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 5,
        name: 'Ariane 6 Demo',
      ...
      pad: {
        id: 185,
        name: 'ELA-4',
        location: { id: 13, name: 'Guiana Space Centre', country_code: 'GUF' },
        latitude: '5.239',
        longitude: '-52.768',
      ...
      rocket: {
        ...
        configuration: {
          ...
          family: 'Ariane',
          variant: '62',
          image_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/ariane_6_image_20190207032507.jpeg',
        },
      },
      launch_service_provider: {
        id: 115,
        ...
        type: 'Commercial',
        country_code: 'FRA',
        logo_url: 'https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/images/arianespace_logo_20190207032425.png',
      },
  ...
  return [
    {
      ...
      status: { id: 3, name: 'Launch Successful', abbrev: 'Success', description: 'Launch was successful' },
      net: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      window_start: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      window_end: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000).toISOString(),
      mission: {
        id: 101,
    ...
    },
    {
      ...
      pad: {
        ...
        location: { id: 27, name: 'Kennedy Space Center, FL, USA', country_code: 'USA' },
